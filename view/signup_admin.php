                ...
                <div class="content-form_img--citizen">
                    ...
                    <div class="content-form_img--text">
                        <div class="form_text--main">
                            <h2>Welcome administrators to the Blood mana community!</h2>
                            <hr>
                            <p>Your contributions provide a big impact to elevate the Vietnamese health ecosystem</p>    
                        </div>
                        ...
                        <form action="">
                            ...
                            <div class="content-form_footer">
                                <div class="content-form_footer-item">                        
                                    <input class="submit-button admin-button" id="admin_button"value="Register"></input>
                                </div>
                                <div class="content-form_footer-item">
